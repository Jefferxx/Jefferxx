...
I am a **Software Engineer** specializing in **Multi-Agent Orchestration**, **Private RAG Systems**, and **Institutional-Grade Automation**. My focus is bridging the gap between cutting-edge AI Research and production-ready applications.
...
- **Frontend:** Next.js 14+ (RSC), TailwindCSS, TypeScript.
- **Infrastructure:** Docker, PostgreSQL (JSONB), Redis, Celery (Async Processing).
